...
const LeftProjectDetail = ({title, backgroundImg, subtitle, description, tech, link}) => {
  ...
  return (
    <div className='flex flex-col gap-4 xl:flex-row'>
      <div className='basis-[40%] flex flex-col relative gap-4 order-2 xl:order-1'>
        ...
        <div className='basis-2/3 xl:absolute xl:w-[400px] left-0 top-[40%] flex flex-col gap-4 z-10'>
